...
export default function Page() {
  return (
    <div>
      <Image src="/monsters/monster-1.svg" width={240} height={240} alt="" className="mx-auto mb-6" />
      ...
      <ol className="border list-decimal text-left pl-12 bg-muted text-muted-foreground p-4 rounded-lg mb-6 leading-loose">
        <li>
          <code className="px-2 py-1 border rounded-md bg-white">***+clerk_test@example.com</code>
          でデモアカウントを作成できます。
        </li>
        <li>
          <code className="px-2 py-1 border rounded-md bg-white">424242</code> の認証コードでログインできます。
        </li>
      </ol>
